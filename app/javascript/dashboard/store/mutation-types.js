export default {
  ...
  UPDATE_PROPOSAL_EVALUATION: 'UPDATE_PROPOSAL_EVALUATION',
  CHANGE_SELECTED_FEEDBACK_ID: 'CHANGE_SELECTED_FEEDBACK_ID',
  RESET_SELECTED_FEEDBACK_ID: 'RESET_SELECTED_FEEDBACK_ID',
  CHANGE_SELECTED_STATUS_TAB_INDEX: 'CHANGE_SELECTED_STATUS_TAB_INDEX',
  ADD_PRO_CON: 'ADD_PRO_CON',
  DELETE_PRO_CON: 'DELETE_PRO_CON',
  UPDATE_PRO_CON: 'UPDATE_PRO_CON',
  SET_BULK_SELECT_INDEX: 'SET_BULK_SELECT_INDEX',
  SET_BULK_EDIT_CHECK_STATUS: 'SET_BULK_EDIT_CHECK_STATUS',
  RESET_BULK_EDIT_CHECK_STATUS: 'RESET_BULK_EDIT_CHECK_STATUS',
  UPDATE_MULTIPLE_FEEDBACKS: 'UPDATE_MULTIPLE_FEEDBACKS',
  DELETE_MULTIPLE_FEEDBACKS: 'DELETE_MULTIPLE_FEEDBACKS',
  CHANGE_SELECTED_STATUS_TAB_FILTER: 'CHANGE_SELECTED_STATUS_TAB_FILTER',
